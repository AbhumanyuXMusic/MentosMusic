...
def start_pannel():  
    buttons  = [
            [
                InlineKeyboardButton(text="🎚 Commands Menu", url="https://t.me/Itz_Venom_xD")
            ],
            [ 
                InlineKeyboardButton(text="📨Official Channel", url="https://t.me/Pubglovers_shayri_lovers"),
                InlineKeyboardButton(text="📨Support Group", url="https://t.me/AlishaSupport")
            ],
    ]
...
pstart_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📢 Uᴘᴅᴀᴛᴇꜱ 📢", url=f"https://t.me/Pubglovers_shayri_lovers"), 
                    InlineKeyboardButton(
                        "💬 Sᴜᴘᴘᴏʀᴛ 💬", url=f"https://t.me/AlishaSupport")
                ],
                [ InlineKeyboardButton("🧑‍💻 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ 🧑‍💻", url=f"https://github.com/NotReallyShikhar/YukkiMusicBot"),]
